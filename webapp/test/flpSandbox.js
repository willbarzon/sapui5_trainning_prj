		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAPUI5 Trainning",
									"targetURL": "#sapui5trainningprj-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapui5trainningprj-display": {
								"semanticObject": "sapui5trainningprj",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapui5trainningprj",
									"url": sap.ui.require.toUrl("sapui5trainningprj")
								}
							}
						}
					}
